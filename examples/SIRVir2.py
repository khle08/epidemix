...
from epidemix.equations import SIRVir2
...
epi = VacciModel(G, SIRVir2, num_state=6, params=[
    4, 2, 0, 0, 0, 0.3, 0.1, 0.1, 0.01, 0.6, 0.01, 0.1, 0.1, 0.1],
...
epi.set_propagate(2, 3, neighbor=None, update_state=True)

epi.set_propagate(3, 4, neighbor=1, update_state=False)
epi.set_propagate(4, 5, neighbor=None, update_state=False)
epi.set_propagate(5, 3, neighbor=None, update_state=False)
epi.set_propagate(5, 0, neighbor=None, update_state=True)
